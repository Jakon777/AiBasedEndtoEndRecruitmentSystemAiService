...
# from core.job_manager import compute_resume_job_similarity, get_required_skills, get_job
...
#     job_desc = get_job(candidate["job_id"])["description"]
#     test_data = generate_test(job, job_desc, "Intermediate")
